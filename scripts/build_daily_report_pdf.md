# Code Doc - build_daily_report_pdf.py

## Source
- `scripts/build_daily_report_pdf.py`
- [Apri il file Python sorgente](build_daily_report_pdf.py)
- [Torna all indice del codice](../Pipeline_01/12_CODE/INDEX.md)

## Scopo
Script di publishing che prende dati dal workbook e dagli artifact e costruisce un report PDF giornaliero.
...
## Collegamenti
- [report_giornata_2026-04-22](../Pipeline_01/09_LOGS/report_giornata_2026-04-22.md)
- [INDEX](../Pipeline_01/09_LOGS/INDEX.md)
- [PROJECT_STATE](../Pipeline_01/11_MEMORY/PROJECT_STATE.md)
...
WORKBOOK_PATH = Path(r"C:\Users\Ciruzz\Downloads\MA_Cross_GridSearch_EURUSD_1.xlsx")
